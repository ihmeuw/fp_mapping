#' @title Get GBD covariate metadata
#' @param list String default NULL. A list of covariate names (covariate_name_short in shared.covariate table) to pull metadata for
#'
#' @return data.table of covariate table
#' @export
#'
#' @concept deprecated
